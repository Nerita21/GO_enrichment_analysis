...
params.input_enrich_py = "${launchDir}/modules/python/run_gprofiler.nf"
...
log.info "Paths: ${params.input_tsv} and ${params.output_dir_py} and ${params.input_enrich_py} and Project: ${projectDir} and launch: ${launchDir}"

include { run_gprofiler } from "${params.input_enrich_py}"
...
workflow {
    main:
        ...
        // Step 1: Run g:Profiler enrichment
        py_gprofiler_results = run_gprofiler(ch_input_genes)
}
